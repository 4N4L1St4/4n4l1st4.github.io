...
- ❌ Falta de **disponibilidade** em caso de falha do equipamento  
- ❌ Risco de **furto ou perda física**  
- ❌ Ausência de **backup corporativo adequado**  
- ❌ Dependência de um único ponto de operação (SPOF)  
- ❌ Falta de controle de acesso e auditoria  

### 🔐 Boa prática:

Ambientes corporativos devem estar hospedados em:
...
Compreender que **segurança começa pela disponibilidade e pela arquitetura correta do ambiente**.